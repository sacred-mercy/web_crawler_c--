// can be used in GUI components objects to render only one at a time like dialog boxes and avoid multiple instances of same object
...
// can be used in real life for database connections reducing the overhead of opening and closing connections multiple times., logging, caching and thread pools
